...
# analysis
julia scripts/done/trajectory_overview.jl --h5file "data_assets/Sp4_Nt4_sorted.hdf5" --plot_dir "assets/overview"
julia scripts/done/trajectory_overview.jl --h5file "data_assets/Sp4_Nt5_sorted.hdf5" --plot_dir "assets/overview"
julia scripts/done/trajectory_overview.jl --h5file "data_assets/Sp4_Nt6_sorted.hdf5" --plot_dir "assets/overview"

julia scripts/an_histories.jl --h5file "data_assets/Sp4_Nt4_sorted.hdf5" --plot_dir "assets/an_trajectories"
julia scripts/an_histories.jl --h5file "data_assets/Sp4_Nt5_sorted.hdf5" --plot_dir "assets/an_trajectories"
julia scripts/an_histories.jl --h5file "data_assets/Sp4_Nt6_sorted.hdf5" --plot_dir "assets/an_trajectories"
...
julia scripts/done/double_gaussian_fit.jl --h5file "data_assets/Sp4_Nt4_sorted.hdf5" --plot_dir "assets/plaquette_distribution" --xmin 0.567  --xmax 0.577  --beta_min 7.337 --beta_max 7.343
julia scripts/done/double_gaussian_fit.jl --h5file "data_assets/Sp4_Nt5_sorted.hdf5" --plot_dir "assets/plaquette_distribution" --xmin 0.5885 --xmax 0.5905 --beta_min 7.488 --beta_max 7.492
#julia scripts/done/double_gaussian_fit.jl --h5file "data_assets/Sp4_Nt6_sorted.hdf5" --plot_dir "assets/plaquette_distribution" --xmin 0.601  --xmax 0.603  --beta_min 7.615 --beta_max 7.623
...
#julia scripts/done/double_gaussian_volumes.jl --h5file "data_assets/Sp4_Nt6_sorted.hdf5" --plotfile "assets/plaquette_distribution_Nt6_volumes.pdf" --xmin 0.601  --xmax 0.603  --beta_min 7.615 --beta_max 7.623
