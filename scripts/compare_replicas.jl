...
a_vs_central_action_plot(h5id,runs::Vector,Nt,Nl;kws...) = a_vs_central_action_plot!(plot(),h5id,runs,Nt,Nl;kws...)
function a_vs_central_action_plot!(plt,h5id,runs::Vector,Nt,Nl;kws...)
    ...
    plot!(plt,title=L"N_t\times N_l^3\!=\!%$Nt\times %$Nl^3",xlims=(xmin,xmax),ylims=(ymin,ymax))
    return plt
end     
